...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div data-dojo-type="mui/header/HeaderItem" 
		...
		data-dojo-props="href:'/chenyee/quotecenter/chenyee_qc_apply/mobile/index.jsp'">
	</div>
	<div data-dojo-type="mui/header/HeaderItem" 
...
<div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
	<div
		...
		data-dojo-props="modelName:'com.landray.kmss.chenyee.quotecenter.model.ChenyeeQcApply',needPrompt:false,height:'3.8rem'">
	</div>
