				...
				seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($, dialog , topic){
					dialog.confirm('<bean:message key="page.comfirmDelete"/>',function(value){
						if(value==true){
							...
							$.post('${LUI_ContextPath}/chenyee/quotecenter/chenyee_qc_apply/chenyeeQcApply.do?method=deleteall&categoryId=${param.categoryId}',$.param({"List_Selected":values},true),function(data){
								if(del_load!=null){
									del_load.hide();
		...
		<ui:fixed elem=".lui_list_operation"></ui:fixed>
	 	...
	 	<list:listview id="listview">
			...
			<list:colTable isDefault="false"
				rowHref="/chenyee/quotecenter/chenyee_qc_apply/chenyeeQcApply.do?method=view&fdId=!{fdId}"  name="columntable">
				<list:col-checkbox></list:col-checkbox>
				<list:col-serial></list:col-serial>
				 
               <list:col-auto props="fdProjectName;fdCostPrice;fdCustomerName;fdBottomPrice;fdApplicationPrice;fdApplicationTime;docStatus;"></list:col-auto>
               
                <list:col-html title="${ lfn:message('chenyee-quotecenter:chenyeeQcApply.downloadApply') }" style="text-align:center">
               {$ <a class="com_subject" href="${LUI_ContextPath}/chenyee/quotecenter/chenyee_qc_apply/chenyeeQcApply.do?method=downloadPdf&filePath={%row['fdQuotePath']%}">{%row['fdApplicationTitle']%}</a> $}
               </list:col-html>
			</list:colTable>
	 	...
	 	<script>
	 		seajs.use([
				...
				window.initMenuNav = function() {
			 		resetMenuNavStyle($(".quoteapply a"));
			 	};				   	  
			});
	 	</script>
	</template:replace>
