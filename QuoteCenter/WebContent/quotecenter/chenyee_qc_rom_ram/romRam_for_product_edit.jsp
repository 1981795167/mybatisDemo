...
<table class="tb_normal" width=100% id="TABLE_DocList" align="center" tbdraggable="true">
	...
	<tr KMSS_IsReferRow="1" style="display: none">
		...
		<td style="width: 15%" align="center">
			<xform:text property="romRamForms[!{index}].fdBomPrice" showStatus="readOnly" style="width:93%;" validators="positiveNum" required="true" />
		</td>
		<td style="width: 15%" align="center">
		<xform:text property="romRamForms[!{index}].fdPurchasePrice" showStatus="readOnly" style="width:93%;" validators="positiveNum" required="true" />
		</td>
		<td style="width: 15%" align="center">
		<xform:text property="romRamForms[!{index}].fdProductPrice" showStatus="readOnly" style="width:93%;" validators="positiveNum" required="true" />
		</td>
		<!-- 删除 -->
	...
	<!-- <script type="text/javascript">
		LUI.ready(function(){
			setTimeout(function(){
				//chenyee @liuxf  2017.12.24  modify start----------
				for (var i = 0; i < 1; i ++) {
				//chenyee @liuxf  2017.12.24  modify end----------
				addRomRam();
				}
			},1000); 
