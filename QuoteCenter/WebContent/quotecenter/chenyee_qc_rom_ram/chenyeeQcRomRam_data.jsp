...
<list:data>
	<list:data-columns var="chenyeeQcRomRam" list="${queryPage.list}" varIndex="status">
		...
		<list:data-column col="docCreator.fdName" title="${ lfn:message('chenyee-quotecenter:chenyeeQcRomRam.docCreator') }">
			<c:out value="${chenyeeQcRomRam.docCreator.fdName}" />
		</list:data-column>
	</list:data-columns>
