...
<table class="tb_normal" width=100% id="TABLE_DocList_Product" align="center" tbdraggable="true">
	<tr align="center">
		...
		<td width="35%">
			<xform:text property="fdProjectName" style="width:85%" showStatus="view"/>
			<!-- 客户定制需要提交项目名称,但view属性不可提交,因此增加该行 -->
			<xform:text property="fdProjectName" style="width:85%" showStatus="noShow"/>
		</td>
		<%-- <td class="td_normal_title" width=15%>
			<bean:message bundle="chenyee-quotecenter" key="chenyeeQcProduct.fdStandard"/>
		</td>
		<td width="35%">
			<xform:text property="fdStandard" style="width:85%" showStatus="view"/>
		</td> --%>
	</tr>
	<tr align="center">
		<td class="td_normal_title" width=15%>
		...
		<td width="35%">
			<xform:text property="fdAndroidVersion" style="width:85%" showStatus="view"/>
		</td>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="chenyee-quotecenter" key="chenyeeQcProduct.fdRearCamera"/>
		</td>
		<td width="35%">
			<xform:text property="fdRearCamera" style="width:85%" showStatus="view"/>
		</td>
	</tr>
	<tr align="center">
		<td class="td_normal_title" width=15%>
		...
		<td width="35%">
			<xform:text property="fdBatteryCapacity" style="width:85%" showStatus="view"/>
		</td>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="chenyee-quotecenter" key="chenyeeQcProduct.fdFrontCamera"/>
		</td>
		<td width="35%">
			<xform:text property="fdFrontCamera" style="width:85%" showStatus="view"/>
		</td>
	</tr>
	<tr align="center">
		<td class="td_normal_title" width=15%>
		...
		<td width="35%">
			<xform:text property="fdScreeSize" style="width:85%" showStatus="view"/>
		</td>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="chenyee-quotecenter" key="chenyeeQcProduct.fdHardwarePlatform"/>
		</td>
		<td width="35%">
			<xform:text property="fdHardwarePlatform" style="width:85%" showStatus="view"/>
		</td>
	</tr>
</table>