...
<template:include ref="mobile.view" compatibleMode="true">
	...
	<template:replace name="content">
		<div data-dojo-type="mui/view/DocScrollableView" id="chenyeeQcProductForm">
			<div class="muiDocFrame">
				<div class="muiDocSubject">
				</div>
				<div class="muiDocInfo">
					<span> <c:out value="${chenyeeQcProductForm.docCreateTime  }" />
					</span>
				</div>
			</div>
			<c:if test="${chenyeeQcProductForm.docStatus >= '30' }">
