...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div
		...
		data-dojo-props="defaultUrl:'/chenyee/quotecenter/chenyee_qc_hardware/mobile/nav.jsp', modelName:'com.landray.kmss.chenyee.quotecenter.model.ChenyeeQcHardware'">
	</div>
	<div
		data-dojo-type="mui/search/SearchButtonBar" 
		data-dojo-props="modelName:'com.landray.kmss.chenyee.quotecenter.model.ChenyeeQcHardware'">
	</div>
</div>
